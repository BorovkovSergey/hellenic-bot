...
export function Home({ lang, onSettings, onStartLesson, refreshKey }: HomeProps) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", padding: "24px", color: "var(--tg-theme-text-color)" }}>
      {/* Top: header + progress */}
      <div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
      ...
      <div style={{ paddingBottom: "24px" }}>
        {allZero ? (
          <p style={{ textAlign: "center", opacity: 0.7 }}>{i.allCaughtUp}</p>
        ) : (
